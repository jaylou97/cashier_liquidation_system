            ...
            <!-- BEGIN SAMPLE FORM PORTLET-->
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject uppercase">masterfile table</span>
                        </div>              
                    </div>
                    <div class="portlet-body row" id="divbody_masterfile_table">
...
<!-- =========================================================VIEWING FORM====================================================================== -->
                    <form class="form-inline" style="">
                      <label style="margin-left: 15%; font-weight: bold;">BUSINESS UNIT</label> <label style="margin-left: 30%; font-weight: bold;">DEPARTMENT</label><br>
                        <select class="input-sm data" onchange="get_dept_name_js()" id="bunit_name" style="height: 30px; width: 50%;">
                  
                        </select>

                        <select class="input-sm data" onchange="display_mop_js()" id="dept_name" style="height: 30px; width: 49%;">
                  
                        </select>
                    </form><br>
                    <div id="masterfile_column">
