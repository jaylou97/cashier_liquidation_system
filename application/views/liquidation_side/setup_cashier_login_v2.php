...
<div class="page-container">
  ...
  <div class="page-content" style="background: #ffffff;">
            ...
            <!-- BEGIN SAMPLE FORM PORTLET-->
                <div class="portlet light dialog">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject uppercase">set-up cashier log-in</span>
                        </div>              
                    </div>

    <div class="portlet-body row" id="divbody_setup_login">
               
        <form class="form-inline" style="margin-left: 15%;">
          <label style="font-weight: bold;">BUSINESS UNIT:</label>
            <select class="input-sm data" onchange="scl_get_dept_name_js()" id="bunit_name" style="height: 35px; width: 25%;">
      
            </select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

          <label style="font-weight: bold;">DEPARTMENT:</label>
            <select class="input-sm data" onchange="scl_get_cashier_name_js()" id="dept_name" style="height: 35px; width: 25%;">
    ...
    <!-- ===========================================FIRST COLUMN========================================= -->
          <div class="column">
            <div class="form-body" id="div_empname_list" style="margin-top: 2%;">
        ...
        <!-- ===========================================END COLUMN====================================</FORM> -->
         ...
         <!-- ===========================================SECOND COLUMN========================================= -->
          <div class="column">
            <div class="form-body" id="div_cashier_personnel_list" style="margin-top: 2%;">
