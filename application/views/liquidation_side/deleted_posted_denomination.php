                ...
                <div class="portlet light">
                    ...
                    <!-- <form class="form-inline">
                      <center>
                        ...
                        <input type="date" onchange="get_deleted_posted_js()" style="height: 35px;" id="filter_date" value="<?php echo date('Y-m-d'); ?>">
                      </center>
                    </form> -->
                    <div class="portlet-body" id="divbody_deleted_posted_dentable">
