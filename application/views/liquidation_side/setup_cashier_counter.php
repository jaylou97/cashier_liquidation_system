            ...
            <!-- BEGIN SAMPLE FORM PORTLET-->
                <div class="portlet light dialog">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject uppercase">set-up cashier assigned counter</span>
                        </div>              
                    </div>
    ...
    <div class="portlet-body row" id="divbody_cashier_counter">
        ...
        <footer>
          <div id="footer-content">
              <center><button type="button" id="set_counter_btn" class="btn btn-warning waves-effect" onclick="set_assigned_counter_js()">SET ASSIGNED COUNTER</button></center>
          </div>
        </footer>
        <!-- ======================================================================================================================================== -->
        ...
        <div class="row">
            ...
            <!-- BEGIN SAMPLE FORM PORTLET-->
                <div class="portlet light dialog">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject uppercase">cashier assigned counter</span>
                        </div>              
                    </div>
