            ...
            <!-- BEGIN SAMPLE FORM PORTLET-->
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject uppercase">confirmed denomination table</span>
                        </div>              
                    </div>
                    <div class="portlet-body" id="divbody_confirmed_dentable">
...
<!-- END PAGE LEVEL PLUGINS -->
  ...
  view_confirmed_denomination_js();
