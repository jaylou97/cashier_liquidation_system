            ...
            <!-- BEGIN SAMPLE FORM PORTLET-->
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject uppercase">deleted pending cash denomination table</span>
                        </div>              
                    </div>
                    <!-- <form class="form-inline">
                      <center>
                        <label style="font-weight: bold">FILTER DATE:</label>
                        <input type="date" onchange="deleted_pending_cash_js()" style="height: 35px;" id="filter_date" value="<?php echo date('Y-m-d'); ?>">
                      </center>
                    </form> -->
