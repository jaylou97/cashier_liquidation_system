            ...
            <!-- BEGIN SAMPLE FORM PORTLET-->
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject uppercase">cashier partial remitted table</span>
                        </div>              
                    </div>
                    <form class="form-inline">
                      <center>
                        <label style="font-weight: bold">FILTER DATE:</label>
                        <input type="date" onchange="view_cashier_partial_remitted_js()" style="height: 35px;" id="filter_date" value="<?php echo date('Y-m-d'); ?>">
                      </center>
                    </form>
                    <div class="portlet-body" id="divbody_partial_remitted_table">
...
<!-- ================================================================================================================================================ -->
    ...
    view_cashier_partial_remitted_js();
