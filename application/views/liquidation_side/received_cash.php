            ...
            <!-- BEGIN SAMPLE FORM PORTLET-->
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject uppercase">received cash sales table</span>
                        </div>              
                    </div>
                    <!-- ===================================================================================================================================== -->
                    <form class="form-inline" style="margin-left: 15%;">
                      <label style="font-weight: bold; font-size: 15px;">BUSINESS UNIT:</label>
                      <select class="input-sm data" onchange="received_cash_get_dept_name_js()" id="bunit_name" style="height: 35px; width: 25%; font-size: 15px;"></select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <label style="font-weight: bold; font-size: 15px;">DEPARTMENT:</label>
                      <select class="input-sm data" onchange="received_cash_js()" id="dept_name" style="height: 35px; width: 25%; font-size: 15px;"></select>
                    </form>
                    <!-- ===================================================================================================================================== -->
                    <div class="portlet-body" id="divbody_received_cash_table">
                       <!-- ==========transferred denomination table list==================== -->
                    </div> 
                    <div id="footer-content">
                        <center><button type="button" id="remit_btn" class="btn btn-warning waves-effect" onclick="remit_to_treasury_js()">REMIT TO TREASURY 💸</button></center>
                    </div><br>
                </div>  
            </div>  
        </div>    
...
<!-- ================================================================================================================================================ -->
    ...
    <script type="text/javascript">
      ...
      received_cash_get_bunit_name_js();
