            ...
            <!-- BEGIN SAMPLE FORM PORTLET-->
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject uppercase">end of day summary report table</span>
                        </div>              
                    </div>
                    <form class="form-inline">
                      <center>
                        <label style="font-weight: bold; font-size: 15px;">BUSINESS UNIT:</label>
                        <select class="input-sm data" onchange="end_of_day_get_dept_name_js()" id="bunit_name" style="height: 35px; width: 25%; font-size: 15px;"></select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <label style="font-weight: bold; font-size: 15px;">DEPARTMENT:</label>
                        <select class="input-sm data" id="dept_name" style="height: 35px; width: 25%; font-size: 15px;"></select><br><br>
                        <label style="font-weight: bold">FILTER DATE:</label>
                        <input type="date" style="height: 35px;" id="filter_date" value="<?php echo date('Y-m-d'); ?>">
                        <button type="button" id="print_btn" class="btn waves-effect" onclick="print_end_of_day_report_js()" style="margin-top: -3px; color: white; background-color: brown;">PRINT 🖨️</button>
                      </center>
                    </form>
                    <div class="portlet-body" id="divbody_table">
