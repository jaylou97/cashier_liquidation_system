        ...
        <div class="row">
            ...
            <!-- BEGIN SAMPLE FORM PORTLET-->
                <div class="portlet light">
                    ...
                    <div class="portlet-body1" id="divbody_cashier_login_access_table">
                       <form id="cashier_login_access_form">
                            <table class="table table-bordered table-hover table-condensed display" id="cashier_access_table">
                                <!-- ================================================================================== -->
                            </table>
                        </form> 
                    </div> 
