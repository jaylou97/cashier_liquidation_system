            ...
            <!-- BEGIN SAMPLE FORM PORTLET-->
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject uppercase">pending denomination table</span>
                        </div>              
                    </div>
                    <div class="portlet-body" id="divbody_pending_noncash_dentable">
