            ...
            <!-- BEGIN SAMPLE FORM PORTLET-->
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject uppercase">adjusted zero registered sales table</span>
                        </div>              
                    </div>
                    <!-- <form class="form-inline">
                      <center>
                        <label style="font-weight: bold">FILTER DATE:</label>
                        <input type="date" onchange="posted_denomination_js()" style="height: 35px;" id="filter_date" value="<?php echo date('Y-m-d'); ?>">
                      </center>
                    </form> -->
                    <div class="portlet-body" id="divbody_adjusted_zero_rs_table">
...
<!-- ================================================================================================================================================ -->
    ...
    adjusted_zero_registered_sales_js();
