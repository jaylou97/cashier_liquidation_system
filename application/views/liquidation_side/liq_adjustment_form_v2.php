            ...
            <!-- BEGIN SAMPLE FORM PORTLET-->
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject uppercase">liquidation / tms -- variance list</span>
                        </div>              
                    </div>
                    <div class="portlet-body" id="divbody_variance_table">
                     
<!-- =========================================================VIEWING FORM====================================================================== -->
                            <table class="table table-striped table-bordered table-hover display" id="variance_table" style="color: black; font-size: 12px;">
                                <thead>
                                    <tr>
                                       <!--  <th>
                                            <center>TR NO.
                                ...
                                <form name="variance_viewing_form" id="variance_viewing_form">
                                    <tbody id="variance_viewing_tbody">
        ...
        <div class="row">
            ...
            <!-- BEGIN SAMPLE FORM PORTLET-->
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject uppercase">liquidation / tms -- adjusted list</span>
                        </div>              
                    </div>

                    <form class="form-inline" style="margin-left: 30%;">
                      <label>FROM:</label>
                      <input type="date" onchange="display_adjusted_js()" style="height: 35px;" id="dtfrom" value="<?php echo date('Y-m-d'); ?>">
                      <label>TO:</label>
                      <input type="date" onchange="display_adjusted_js()" style="height: 35px;" id="dtto" value="<?php echo date('Y-m-d'); ?>">
                    </form>
