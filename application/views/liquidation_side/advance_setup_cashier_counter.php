            ...
            <!-- BEGIN SAMPLE FORM PORTLET-->
                <div class="portlet light dialog">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject uppercase">advance set-up cashier assigned counter</span>
                        </div>              
                    </div>
    ...
    <div class="portlet-body row" id="divbody_cashier_counter">
        ...
        <form class="form-inline">
          <center>
            ...
            <input type="date" style="height: 35px;" id="filter_date">
            <label class="checkbox-inline" style="margin-top: 2%; margin-left: 25px; font-weight: bold; margin-top: -10px; font-size: 15px;">
              <input type="checkbox" id="borrow_checkbox" onclick="setup_counter_checked_borrow()" style="width: 26px; height: 26px; margin-top: -2px; margin-left: -28px; font-size: 15px;" value="">BORROW
            </label>
            <select id="pos_name" style="font-size: 17px; font-weight: bold; margin-left: 15px;" onchange="get_counter_no_js()"></select>
            &nbsp;&nbsp;&nbsp;
            <span id="counter_no" style="font-size: 17px; font-weight: bold;"></span><br><br>
            <!-- =============================================================================================================================== -->
            <div hidden id="cash_section_form">
                  <select style="font-size: 17px; font-weight: bold;" name="cash_section" id="cash_section" onchange="setup_counter_get_sub_section_js()">
        ...
        <footer>
          <div id="footer-content">
              <center><button type="button" id="set_counter_btn" class="btn btn-warning waves-effect" onclick="advance_set_assigned_counter_js()">ADVANCE SET ASSIGNED COUNTER</button></center>
          </div>
        </footer>
        <!-- ======================================================================================================================================== -->
        ...
        <div class="row">
            ...
            <!-- BEGIN SAMPLE FORM PORTLET-->
                <div class="portlet light dialog">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject uppercase">advance cashier assigned counter</span>
                        </div>              
                    </div>

    <div class="portlet-body row" id="divbody_cashier_assigned_counter">
        <!-- ======================================================================================================================================== -->
