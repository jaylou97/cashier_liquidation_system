            ...
            <!-- BEGIN SAMPLE FORM PORTLET-->
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject uppercase">batch remitted cash sales table</span>
                        </div>              
                    </div>
                    <form class="form-inline">
                      <center>
                        <label style="font-weight: bold">FILTER DATE:</label>
                        <input type="date" onchange="partial_remitted_cash_js()" style="height: 35px;" id="filter_date" value="<?php echo date('Y-m-d'); ?>">
                      </center>
                    </form>
                    <div class="portlet-body" id="divbody_partial_remitted_cash_table">
