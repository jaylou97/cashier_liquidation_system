...
<!-- =================================================adjustment modal======================================================= -->
    <div class="modal" tabindex="-1" id="managers_key_modal" style="padding-right: 0px; margin-right: -130%;">
      <div class="modal-dialog">
        <div class="modal-content" id="managers_key_contentmodal" style="width: 80%;">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-warning" onclick="validate_supervisor_approve_js()" id="login_btn">LOG-IN</button>
            <button type="button" class="btn btn-primary" onclick="close_mkey_modal_js()">CLOSE</button>
          </div>
