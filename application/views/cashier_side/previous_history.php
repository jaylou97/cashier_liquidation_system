            ...
            <!-- BEGIN SAMPLE FORM PORTLET-->
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject uppercase">PREVIOUS SALES REMITTANCE TABLE</span>
                        </div>              
                    </div>
                    <form class="form-inline">
                      <center>
                        <label style="font-weight: bold">FROM:</label>
                        <input type="date" onchange="view_previous_den_js()" style="height: 35px;" id="from_date" value="<?php echo date('Y-m-d'); ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <label style="font-weight: bold">TO:</label>
                        <input type="date" onchange="view_previous_den_js()" style="height: 35px;" id="to_date" value="<?php echo date('Y-m-d'); ?>">
                      </center>
                    </form>
                    <div class="portlet-body" id="divbody_previous_table">
                       <!-- ==========previous denomination table list==================== -->
                    </div> 
                </div>  
            </div>  
        </div>    
