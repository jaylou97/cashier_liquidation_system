    ...
    <div class="page-container">
        ...
        <div class="page-content" style="background: #ffffff;">
            <div class="container">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet light">
                            <div class="portlet-title">
                                <div class="caption">
                                    <span class="caption-subject uppercase">FINAL CASH DENOMINATION FORM</span>
                                </div>
                                
                              <input hidden type="text" id="checkbox_cashremit">
                              <input hidden type="text" id="cash_trno">
                              <form style="margin-left: 34%;">
                                <label class="checkbox-inline" style="font-size: 15px; margin-top: 2%; margin-left: 45px; font-weight: bold;">
                                  ...
                                  <input type="checkbox" id="final_checkbox" disabled style="width: 20px; height: 20px; margin-top: -1px; margin-left: -24px;" value="">FINAL REMITTANCE
                                </label>
                                <label class="checkbox-inline" style="font-size: 15px; margin-top: 2%; margin-left: 45px; font-weight: bold;">
                                                        ...
                                                        <form name="cash_form" id="cash_form">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text" class="input-sm" readonly disabled id="total_cash" placeholder="0.00">
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </form>
                ...
                // ===============================================CHECKED FINAL=====================================================================
                $(function() {
                    $("#final_checkbox").prop('checked', true);
