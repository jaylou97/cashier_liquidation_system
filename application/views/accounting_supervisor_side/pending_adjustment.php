            ...
            <!-- BEGIN SAMPLE FORM PORTLET-->
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject uppercase">PENDING ADJUSTMENT</span>
                        </div>              
                    </div>
                    <div class="portlet-body" id="pending_adjustment_div">
<!-- =========================================================VIEWING FORM====================================================================== -->
                    ...
                    <div style="height: 30px;"> 
                      <footer id="liq_masterfile_footer">
                        <div id="footer-content" style="float: right;">
                          <button type="button" id="save_btn" class="btn btn-warning waves-effect" onclick="approve_pending_request_js()">APPROVE REQUEST 👍</button>
                        </div>
                      </footer>
                    </div> 
                </div>  
