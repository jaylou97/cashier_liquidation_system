            ...
            <!-- BEGIN SAMPLE FORM PORTLET-->
                <div class="portlet light dialog">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject uppercase">add payment form</span>
                        </div>              
                    </div>

    <div class="portlet-body row" id="divbody_add_payment">
    ...
    <!-- ===========================================CASH DENOMINATION FORM========================================= -->
          <div class="column">
            <div class="form-body" id="form_body">
                <div class="table-scrollable">
                    <table class="table table-striped table-bordered table-hover display" style="color: black; font-size: 12px;">
                        ...
                        <form name="addpayment_form" id="addpayment_form">
                            <tbody>
                                <tr>
                                    <td width="35%">
                                        <input type="text" class="input-sm txt" id="" disabled="" value="Type:">
                                    </td>
                                    <td>
                                        <select class="input-sm data" id="ap_type" onclick="disabled_option_select_type_js()" style="height: 35px;">
                                           <option id="op_st">Select Type</option>
                                           <option>CASH</option>
                                           <option>NONCASH</option> 
                                        </select>
                                    </td>
                                </tr>
                                 <tr>
                                    <td width="35%">
                                        <input type="text" class="input-sm txt" id="" disabled="" value="Mode Of Payment:">
                                    </td>
                                    <td>
                                        <input type="text" class="input-sm uppercase data" autocomplete="off" id="ap_mop" placeholder="">
                                    </td>
                                </tr>
                                <tr>
                                    <td width="35%">
                                    ...
                                    <td>
                                        <select class="input-sm data" onchange="display_department_js()" id="bunit_name" style="height: 35px;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="input-sm data" id="dept_name" style="height: 35px;">
            ...
            <footer id="footer">
              <div id="footer-content" style="float: right;">
                 <button type="button" id="" onclick="save_payment_js()" class="btn btn-warning waves-effect" onclick="">SAVE</button>
                 <button type="button" id="" class="btn btn-primary waves-effect" onclick="cancel_js()">CANCEL</button>
              </div>
            </footer>
        ...
        <!-- ===========================================END CASH DENOMINATION FORM====================================</FORM> -->
         ...
         <!-- ===========================================NONCASH DENOMINATION FORM========================================= -->
          <div class="column">
            <div class="form-body" id="div_payment_list" style="margin-top: 2%;">
