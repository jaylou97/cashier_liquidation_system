            ...
            <!-- BEGIN SAMPLE FORM PORTLET-->
                <div class="portlet light dialog">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject uppercase">mode of payment form</span>
                        </div>              
                    </div>
          ...
          <div class="column">
                        ...
                        <thead>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td width="65%">
                                        <select class="input-sm" onchange="display_department_js()" onclick="disabled_select_bu_js()" id="bunit_name" style="height: 35px; text-align: left;">
                                ...
                                <tr>
                                    ...
                                    <td width="65%">
                                        <select class="input-sm data" id="dept_name" onchange="display_mop_js()" onclick="disabled_select_dept_js()" style="height: 35px;">
            ...
            <footer id="footer">
              <div id="footer-content" style="float: right;">
                 <button type="button" id="save_btn" onclick="save_payment_js_v2()" class="btn btn-warning waves-effect">ADD</button>
              </div>
            </footer><br><br><br>
