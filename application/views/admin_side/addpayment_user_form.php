...
<!-- END PAGE LEVEL STYLES -->
  ...
  <link href="<?php echo base_url();?>assets/css/jquery-ui.css" rel="stylesheet">
    ...
    <!-- ====================================================AUTO COMPLETE SEARCH PLUGINS============================================== -->
    <!-- <link rel="stylesheet" href="//code.jquery.com/ui/1.13.2/themes/base/jquery-ui.css">
    <link rel="stylesheet" href="/resources/demos/style.css"> -->

    <script src="<?php echo base_url(); ?>search_autocomplete_plugins/jquery-3.6.0.js"></script>
    <script src="<?php echo base_url(); ?>search_autocomplete_plugins/jquery-ui.js"></script>
    <!-- ============================================================================================================================== -->
            ...
            <!-- BEGIN SAMPLE FORM PORTLET-->
                <div class="portlet light dialog">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject uppercase">add user access for add payment form</span>
                        </div>              
                    </div>

    <div class="portlet-body row" id="divbody_adduser_access">
    ...
    <!-- ===========================================CASH DENOMINATION FORM========================================= -->
          <div class="column">
            <div class="form-body" id="form_body">
                <div class="table-scrollable">
                    <table class="table table-striped table-bordered table-hover display" style="color: black; font-size: 12px;">
                        ...
                        <form name="adduser_access_form" id="adduser_access_form">
                            <tbody>
                                <!-- <tr>
                                    <td width="35%">
                                    ...
                                    <td>
                                        <select class="input-sm data" id="bunit_name" onchange="get_bunitcode_js()" style="height: 35px;">
                                 ...
                                 <tr>
                                    <td width="35%">
                                        <input type="text" class="input-sm txt" id="" disabled="" value="SEARCH EMPLOYEE:">
                                    </td>
                                    <td>
                                        <input type="text" class="input-sm uppercase data" autocomplete="off" onkeyup="search_emp_js()" id="emp_name" placeholder="">
                                    </td>
                                </tr>
                            </tbody>
                        </form>
            ...
            <footer id="footer">
              <div id="footer-content" style="float: right;">
                 <button type="button" id="" onclick="addpayment_user_js()" class="btn btn-warning waves-effect">ADD</button>
        ...
        <!-- ===========================================END CASH DENOMINATION FORM====================================</FORM> -->
         ...
         <!-- ===========================================NONCASH DENOMINATION FORM========================================= -->
          <div class="column">
            <div class="form-body" id="div_user_list" style="margin-top: 2%;">
