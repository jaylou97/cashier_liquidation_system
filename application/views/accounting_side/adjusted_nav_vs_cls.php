            ...
            <!-- BEGIN SAMPLE FORM PORTLET-->
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject uppercase">adjusted navision vs cls table</span>
                        </div>              
                    </div>
                    <div id="loader">
                    </div>
                    <form class="form-inline">
                      <center>
                          ...
                          <button type="button" class="btn" style="background-color: brown; color: white;" onclick="view_adjusted_variance_navcls_js()" id="variance_btn">👁️ VIEW VARIANCE</button><br><br>
                          ...
                          <button type="button" class="btn" style="background-color: midnightblue; color: white;" onclick="print_adjusted_navcls_js()" id="print_btn">🖨️ PRINT</button>
                          <br><br>
                          ...
                          <label id="sales_date_lbl" style="font-weight: bold; font-size: medium; color: red;"></label><br>
                          <label style="font-weight: bold; font-size: medium;">SHORT:&nbsp;</label>
                          <button type="button" class="btn" style="background-color: red; margin-top: -6px;"></button>
                          <label style="font-weight: bold; font-size: medium; color: lime;">&nbsp;&nbsp;/&nbsp;&nbsp;</label>
                          <label style="font-weight: bold; font-size: medium;">OVER:&nbsp;</label>
                          <button type="button" class="btn" style="background-color: green; margin-top: -6px;"></button>
                          <label style="font-weight: bold; font-size: medium; color: lime;">&nbsp;&nbsp;/&nbsp;&nbsp;</label>
                          <label style="font-weight: bold; font-size: medium;">ADJUSTED:&nbsp;</label>
                          <button type="button" class="btn" style="background-color: magenta; margin-top: -6px;"></button>
                      </center>
                    </form>
...
<!-- ================================================================================================================================================ -->
    ...
    display_sales_date_uploaded_js2();
