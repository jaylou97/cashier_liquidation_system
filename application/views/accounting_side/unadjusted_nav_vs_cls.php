            ...
            <!-- BEGIN SAMPLE FORM PORTLET-->
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject uppercase">navision vs cls table</span>
                        </div>              
                    </div>
                    <div id="loader">
                    </div>
                    <form class="form-inline">
                      <center>
                          ...
                          <button type="button" class="btn" style="background-color: brown; color: white;" onclick="view_variance_navcls_js()" id="variance_btn">👁️ VIEW VARIANCE</button>
                          <button type="button" class="btn" style="background-color: midnightblue; color: white;" onclick="print_variance_js()" id="print_btn">🖨️ PRINT</button>
                          <br><br><br>  
                          ...
                          <label style="font-weight: bold; font-size: medium;">NAVISION AMOUNT:&nbsp;</label>
                          <label style="font-weight: bold; font-size: medium; color: red;">TOP</label>
                          <button type="button" class="btn" style="background-color: blue; margin-top: -6px;"></button>
                          <label style="font-weight: bold; font-size: medium; color: lime;">&nbsp;&nbsp;/&nbsp;&nbsp;</label>
                          <label style="font-weight: bold; font-size: medium;">CLS AMOUNT:&nbsp;</label>
                          <label style="font-weight: bold; font-size: medium; color: red;">BOTTOM</label>
                          <button type="button" class="btn" style="background-color: black; margin-top: -6px;"></button>
                      </center>
                    </form>
